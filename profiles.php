...
$givd=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM students WHERE stuid='$stuid'"));
if($givd==true)
{
...
$query = mysqli_query($con,"UPDATE students SET profile='profiles/$venkateshfname' where stuid='$stuid' ") or die(mysql_error());
if ($query==true){
