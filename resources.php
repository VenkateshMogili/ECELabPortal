<div class="container">
<div class="jumbotron">
<center><h3 style="background-color:#3399ff;padding:10px;box-shadow:1px 2px 3px lightgray;color:white;"><i class='fa fa-folder'></i> Resources</h3></center>
...
if (is_dir($dir)){
  if ($dh = opendir($dir)){
    ...
    if (!in_array($file,array('.','..')) && !is_dir($dir.$file) && $file=str_replace(' ','%20',$file))
      echo "
    <tr class='a'>
    <td width='85%'><i class='fa fa-file'></i> <a href='Resources/$file' title='$file' class='link' id='dn' target='_blank'>".$file=str_replace('%20',' ',$file)."</a></td>
